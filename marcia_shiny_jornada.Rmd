...
# Função pra verificar e instalar um vetor de packages:
...
ler_libs(packages = c("rmarkdown", "shiny", "devtools", "knitr", "rsconnect"))
devtools::install_github('yihui/xaringan')

# Pra upar um aplicativo pro shinyapps.io:
#rsconnect::setAccountInfo(name='teste',
#                          token='token', 
#                          secret='XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
#rsconnect::deployApp('/cloud/project/kmeans-example')
...
```{r, echo = FALSE}
# Renderizando o shiny-app do START na apresentação:
knitr::include_url("https://kcvi.shinyapps.io/START_HT/", height = "500px")
```
